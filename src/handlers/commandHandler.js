...
const help = ctx => {
  helpMsg = `
*🍵CocoaTip help page* \nWhat can I help you with? list of my commands:
                          
Type:

/deposit - for information on depositing 
/help - for information on tipping *COCOA* 
/withdraw - withdrawing *COCOA*  
/balance - get your *COCOA* balance

If you need further assistance go to @cocoa_token chat room.
`;
